...
export default function Footer(){
  ...
  return <footer className={styles.footerWrapper}>
    <div className={`${styles.topGeWrapper} page_container flex flex-col items-center`}>
      ...
      {totalItems > 0 && (
        <Link href="/shop/cart" className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white px-6 py-3 rounded-full shadow-lg hover:bg-blue-700 transition-colors duration-200 flex items-center gap-2">
