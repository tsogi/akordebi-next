...
function getTextAreaPlaceholder(type, notationFormat) {
  ...
  if(type == "karaoke" || notationFormat === "karaoke") {
    return 'მაგალითი:\n თუკი გესიზმრები[0:00:10-0:00:13] \n თუკი გელანდები[0:00:13-0:00:16] \n თუკი გენატრება[0:00:16-0:00:19]\n ჩემი ხმა[0:00:19-0:00:22]\n\n\n ამ შემთხვევაში 10 წამიდან 13 წამამდე გაფერადდება "თუკი გესიზმრები", 13 წამიდან 16 წამამდე გაფერადდება "თუკი გელანდები", 16 წამიდან 19 წამამდე გაფერადდება "თუკი გენატრება", 19 წამიდან 22 წამამდე გაფერადდება "ჩემი ხმა".\n\nფორმატი: სტრიქონი[საათი:წუთი:წამი-საათი:წუთი:წამი]';
  }
