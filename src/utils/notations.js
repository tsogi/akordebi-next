export const notations = [
    { 
        ...
        tabs: [
            { code: "guitar_chord", category: "guitar", name: "აკორდები", page_title: "გიტარის აკორდი", page_title_plural: "გიტარის აკორდები", chordsDir: "/chords/guitar", showTonality: true, showChords: true},
    ...
    },
    {
        ...
        tabs: [
            { code: "fanduri_chord", category: "fanduri", name: "აკორდები", page_title: "ფანდურის აკორდი", page_title_plural: "ფანდურის აკორდები", chordsDir: "/chords/fanduri", showTonality: true, showChords: true},
