const interfaceGeo = {
    ...
    _footer_earn_money: "გამოიმუშავე თანხა",
    ...
    _notes: "ნოტები",
    _chords: "აკორდები",
    _metaTitle: "გიტარა | ფანდური | gitara | fanduri",
    ...
    _footer_chords_library: "აკორდების სია",
    ...
    upload: {
        ...
        tabs: "ტაბები",
        cancel: "გაუქმება",
        add_image_button: "ფოტოს დამატება",
        upload_image: "ტაბის ან ნოტის ფოტოს ატვირთვა",
        upload_image: "აქ შეგიძლიათ ატვირთოთ ტაბის ან ნოტის ან ნებისმიერი დამხმარე ფოტო",
        upload_image_instructions: "ატვირთეთ ტაბის ან ნოტის ფოტო",
        publish: `პლიუს(+) ღილაკების მეშვეობით ატვირტეთ ტექსტი, აკორდები ან ფოტოები. ამ გვერდის ბოლოში შეგიძლიათ ნახოთ `,
...
ბანი დაბლა დაბლა მაღლა დაბლა მაღლა ან ბანი ↓ ↓ ↑ ↓ ↑ ან ბანი 3 2 1 2 3`
    ...
    price: {
        ...
        premium_features: {
            "all_resources": "ყველაფერი რას უფასოშია",
            "unlimited_downloads": "ულიმიტო გადმოწერა",
            "unlimited_tonality": "ულიმიტო ტონალობა",
            "unlimited_favorites": 'ულიმიტო ფავორიტები',
    ...
    donation: {
        title: "დონაცია",
        button: "დონაცია - საიტის მხარდაჭერა",
        support_text: "აირჩიეთ თანხა",
        amount_5: "5 ლარი",
        amount_10: "10 ლარი",
        amount_20: "20 ლარი",
        amount_50: "50 ლარი",
...
const interfaceEng = {
    ...
    _footer_chords_library: "Chords Library",
...
Bass Down Down Up Down Up or Bass ↓ ↓ ↑ ↓ ↑ or Bass 3 2 1 2 3`
    ...
    price: {
        ...
        premium: "Premium",
        premium_price: process.env.NEXT_PUBLIC_MONTHLY_COST + " GEL / month",
...
export { interfaceGeo, interfaceEng };