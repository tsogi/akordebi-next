const interfaceGeo = {
    ...
    upload: {
        ...
        publish: `სიმღერის ${process.env.NEXT_PUBLIC_DOMAIN}-ზე გამოსაქვეყნებლად შეავსეთ ველები და ატვირთეთ ტექსტი და აკორდები პლიუს(+) ღილაკების მეშვეობით. ამ გვერდის ბოლოში შეგიძლიათ ნახოთ `,
