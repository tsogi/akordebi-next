...
export default function CreateSong(){
    return <>
        ...
        <div className={`${styles.createSongPage} page_container`}>
            <div className={styles.uploadLabel}>სიმღერის akordebi.ge-ზე გამოსაქვეყნებლად შეავსეთ ველები და ატვირთეთ ტექსტი პლიუს(+) ღილაკების მეშვეობით. პროცესი არის მარტივი და ინტუიტიური. ასევე, ამ გვერდის ბოლოში, შეგიძლიათ ნახოთ <a className="text-[#f2ac2b] underline" href="#videoInstruction">ატვირთვის ვიდეო ინსტრუქცია</a></div>
            <SongCreator  />
